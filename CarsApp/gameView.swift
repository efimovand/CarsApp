...
struct gameView: View {
    ...
    // Cars
    @State var cars = ["abarth 500", "alfa romeo 4c", "alfa romeo c39", "alfa romeo stradale", "aston martin db11", "audi 100 avant", "audi r18", "bmw m3 e36", "bmw m3 e46", "bmw m3 e92", "bmw m635 e24", "bmw x1", "bugatti chiron", "caterham 21", "charger rt", "chevrolet camaro", "citroen ds23", "devel sixteen", "dome zero", "ferrari f50", "fiat 500", "ford gt 40", "honda civic", "hyundai i20n", "jaguar xjs", "lamborghini diablo", "lancia 037", "lotus europa", "maserati mc12", "maybach sw38", "mazda mx5", "mazda rx7", "mclaren f1", "mercedes a45", "mercedes w25", "mitsubishi evo 7", "mitsubishi evo 8", "nissan fairylady", "nissan gtr r32", "nissan gtr r34", "nissan gtr r35", "nissan silvia s13", "nissan silvia s15", "oldsmobile gr", "peugeot ion", "porsche 911", "renault 19 16s", "renault clio", "renault gordini", "renault megane", "subaru impreza", "suzuki hustler", "suzuki swift", "toyota coaster", "toyota corolla", "toyota crown", "toyota fjcruiser", "toyota gt86", "toyota lc FJ43", "toyota lc76", "toyota mr2", "toyota supra", "vw beetle a4", "vw beetle classic"].shuffled()
    
    @State var longCars = ["alfa romeo stradale", "chevrolet camaro", "lamborghini diablo", "vw beetle classic"]
    ...
    @State var collection_6 = [collection_gti().self]
    @State var collection_7 = [collection_silvia().self]
    @State var collection_8 = [collection_pike().self]
    @State var collection_9 = [collection_tz().self]
    
    @State var correctAnswer = Int.random(in: 0..<4)
    @State var collectionNumber = Int.random(in: 0..<9) // Collections' amount
        ...
        ZStack{
            ...
            // Game Single
                        ...
                        VStack(spacing: 25){
                            ...
                            ForEach(0..<4) { number in
                                ...
                                ZStack{
                                    ...
                                    Text(cars[number])
                                        .foregroundColor(Color.white)
                                        .font(longCars.contains(cars[number]) ? Font.custom("PorterSansBlock", size: 13) : Font.custom("PorterSansBlock", size: 15))
                ...
                ZStack{
                    ...
                    ZStack{
                        collection_6[0]
                    }.opacity(collectionNumber == 5 ? 1 : 0)
                    
                    ZStack{
                        collection_7[0]
                    }.opacity(collectionNumber == 6 ? 1 : 0)
                    
                    ZStack{
                        collection_8[0]
                    }.opacity(collectionNumber == 7 ? 1 : 0)
                    
                    ZStack{
                        collection_9[0]
                    }.opacity(collectionNumber == 8 ? 1 : 0)
    ...
    func nextQuestion() {
        ...
        collectionNumber = Int.random(in: (0..<9)) // Collections' amount
    }
